...
static PyCodeObject *codeobj_a461faf68ed84db47237132cae27ce74;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[1]; CHECK_OBJECT(module_filename_obj);
    codeobj_a461faf68ed84db47237132cae27ce74 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[22], mod_consts[22], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_a461faf68ed84db47237132cae27ce74;
    ...
    frame_a461faf68ed84db47237132cae27ce74 = MAKE_MODULE_FRAME(codeobj_a461faf68ed84db47237132cae27ce74, module_cryptography$hazmat$primitives$ciphers);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_a461faf68ed84db47237132cae27ce74);
    assert(Py_REFCNT(frame_a461faf68ed84db47237132cae27ce74) == 2);
    ...
    // Framed code:
    {
        ...
        tmp_expression_value_1 = GET_STRING_DICT_VALUE(moduledict_cryptography$hazmat$primitives$ciphers, (Nuitka_StringObject *)mod_consts[4]);
    ...
    }
    {
        ...
        tmp_assattr_value_3 = GET_STRING_DICT_VALUE(moduledict_cryptography$hazmat$primitives$ciphers, (Nuitka_StringObject *)mod_consts[4]);
    ...
    }
    {
        ...
        frame_a461faf68ed84db47237132cae27ce74->m_frame.f_lineno = 6;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_a461faf68ed84db47237132cae27ce74, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_a461faf68ed84db47237132cae27ce74->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_a461faf68ed84db47237132cae27ce74, exception_lineno);
    }



    assertFrameObject(frame_a461faf68ed84db47237132cae27ce74);
    ...
    tmp_import_from_1__module = NULL;
    {
        ...
        tmp_assign_source_13 = MAKE_LIST7(mod_consts[20]);
