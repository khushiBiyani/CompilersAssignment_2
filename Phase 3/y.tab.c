...
{
       0,   214,   214,   216,   217,   218,   219,   221,   222,   223,
     224,   225,   226,   227,   229,   229,   230,   231,   232,   233,
     233,   233,   235,   236,   236,   237,   237,   239,   240,   241,
     242,   243,   244,   245,   247,   248,   249,   250,   251,   252,
     253,   254,   255,   256,   259,   259,   260,   260,   261,   262,
     262,   264,   265,   266,   267,   268,   269,   270,   271,   272,
     274,   274,   274,   275,   275,   275,   276,   277,   279,   279,
     279,   280,   280,   280,   281,   281,   281,   282,   282,   283,
     285,   285,   285,   286,   287,   289,   289,   289,   290,   290,
     290,   291,   291,   291,   292,   292,   293,   295,   295,   295,
     296,   296,   297,   297,   297,   297,   298,   299,   300,   301,
     302,   303,   304,   304,   305,   308,   309,   311,   312,   313,
     314,   316,   317,   319,   320,   321,   322,   323,   324,   324,
     325,   325,   326,   326,   327,   328,   329,   330,   331,   332,
     333,   337,   338,   339,   340,   341,   342,   344,   345,   346,
     347,   348,   350,   351,   352,   353,   354,   356,   357,   358,
     359,   360,   362,   363,   365,   366,   368,   369,   370,   372,
     373,   374,   375,   376,   378,   379,   380,   382,   383,   384,
     385,   387,   388,   389,   390,   391,   392,   393,   394,   395,
     396,   399,   400,   403,   404,   406,   406,   407,   408,   410,
     412,   413,   414,   416,   418,   418,   419,   420,   421,   422,
...
#line 346 "SyntaxAnalyzer.y"
                                                       {}
#line 2313 "y.tab.c"
    break;

  case 150: /* declarationListInt: IDENTIFIER dimension  */
#line 347 "SyntaxAnalyzer.y"
...
#line 370 "SyntaxAnalyzer.y"
                                       {printf("E3..\n");}
#line 2415 "y.tab.c"
    break;

  case 173: /* relationalExpression: value  */
#line 376 "SyntaxAnalyzer.y"
                        {printf("VALUE..\n");}
#line 2421 "y.tab.c"
    break;

  case 174: /* value: term ADD value  */
#line 378 "SyntaxAnalyzer.y"
                            {printf("ADD..\n");}
#line 2427 "y.tab.c"
    break;

  case 176: /* value: term  */
#line 380 "SyntaxAnalyzer.y"
               {printf("Basic TERM..\n");}
#line 2433 "y.tab.c"
    break;
...
#line 399 "SyntaxAnalyzer.y"
                                                      {}
#line 2499 "y.tab.c"
    break;

  case 192: /* functionCall: IDENTIFIER OPBRAC argList CLBRAC SEMICOLON  */
#line 400 "SyntaxAnalyzer.y"
                                                              {}
#line 2505 "y.tab.c"
    break;

  case 195: /* $@35: %empty  */
#line 406 "SyntaxAnalyzer.y"
...
#line 2553 "y.tab.c"
  ...
  case 213: /* returnDec: RETURN SEMICOLON  */
#line 427 "SyntaxAnalyzer.y"
                                           {char *temp="#return@#;@";(yyval.Str)=strdup(temp);fprintf(outFile,"%s\n",(yyval.Str));}
#line 2559 "y.tab.c"
    break;

  case 214: /* dimension: BOXOPEN INTVAL BOXCLOSE  */
#line 429 "SyntaxAnalyzer.y"
                                          {char* temp; temp=(char *)malloc(sizeof(char)*100);strcat(temp,"#[@#");strcat(temp,(yyvsp[-1].Str));strcat(temp,"@#]@");(yyval.Str)=strdup(temp);fprintf(outFile,"%s\n",(yyval.Str));}
#line 2565 "y.tab.c"
    break;

  case 215: /* dimension: BOXOPEN INTVAL BOXCLOSE BOXOPEN INTVAL BOXCLOSE  */
#line 430 "SyntaxAnalyzer.y"
                                                                    {char* temp; temp=(char *)malloc(sizeof(char)*100);strcat(temp,"#[@#");strcat(temp,(yyvsp[-4].Str));strcat(temp,"@#]@#[@");strcat(temp,(yyvsp[-1].Str));strcat(temp,"@#]@");(yyval.Str)=strdup(temp);fprintf(outFile,"%s\n",(yyval.Str));}
#line 2571 "y.tab.c"
    break;

  case 216: /* dimension: BOXOPEN BOXCLOSE BOXOPEN INTVAL BOXCLOSE  */
#line 431 "SyntaxAnalyzer.y"
                                                             {char* temp; temp=(char *)malloc(sizeof(char)*100);strcat(temp,"#[@#]@#[@#");strcat(temp,(yyvsp[-1].Str));strcat(temp,"@#]@");(yyval.Str)=strdup(temp);fprintf(outFile,"%s\n",(yyval.Str));}
#line 2577 "y.tab.c"
    break;
