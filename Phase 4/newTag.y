...
statementList :   basicStatement statementList 
...
declarationListFloat : declarationListFloat COMMA IDENTIFIER {push();} EQUAL {push();} expressionStatement {codegen_assign();} COMMA declarationListFloat
		| IDENTIFIER {push();} EQUAL {push();} expressionStatement {codegen_assign();}
		| IDENTIFIER dimension 
		| IDENTIFIER
